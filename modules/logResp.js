...
export function logResp(data, endpoint) {
  ...
  if (endpoint.startsWith("http://localhost:8080/user")) {
    getEntries("user", data);
  }
  if (endpoint.startsWith("add")) {
    getEntries("add", data);
  }
  if (endpoint.startsWith("http://localhost:8080/products")) {
  ...
  if (endpoint.startsWith("http://localhost:8080/cart")) {
  ...
  if (endpoint.startsWith("http://localhost:8080/order")) {
